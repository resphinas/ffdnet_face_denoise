...
from add_noise import BIG_pepper_and_salt_SMALL
...
def main(args):
	...
	for epoch in range(start_epoch, args.epochs):
		...
		for i, data in enumerate(loader_train, 0):
			...
			imgn_train = BIG_pepper_and_salt_SMALL(img_train, 0.1, 8)
...
if __name__ == "__main__":
	...
	parser.add_argument("--gray",default=0,
	...
	main(argspar)
#tensorboard --logdir=D:\A_sell_project\tiaoshi_dl\ffdnet-pytorch\logs --host=127.0.0.1